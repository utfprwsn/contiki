...
#define MAX_QUEUE_MQTT_SN         16            /**< Número máximo de tarefas a serem inseridas alocadas dinamicamente MQTT-SN */
#define MAX_TOPIC_USED            16            /**< Número máximo de tópicos que o usuário pode registrar, a API cria um conjunto de estruturas para o bind de topic e short topic id */
/** @}*/
